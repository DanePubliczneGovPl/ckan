...
def _tag_search(context, data_dict):
    ...
    if data_dict.get('vocabulary_id', None):
...
def user_activity_list(context, data_dict):
    ...
    activity_objects = model.activity.user_activity_list(user.id, limit=limit,
            offset=offset, filtered_out_users=_activity_stream_get_filtered_users())
...
def package_activity_list(context, data_dict):
    ...
    activity_objects = model.activity.package_activity_list(package.id,
            limit=limit, offset=offset, filtered_out_users=_activity_stream_get_filtered_users())
