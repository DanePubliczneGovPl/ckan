{
  ...
  "Failed to load data API information": [
    null,
    "Nie udało się pobrać informacji o dostępie poprzez API"
  ],
  "Follow": [
    null,
    "Obserwuj"
  ...
  "There are unsaved modifications to this form": [
    null,
    "Wartości formularza są niezapisane"
  ],
  "Brak danych o API dla tego zasobu": [
    null,
  ...
  "Unable to authenticate upload": [
    null,
    "Brak praw do przesłania zasobu"
  ],
  "Unable to get data for uploaded file": [
    null,
    "Nie można pobrać danych przesłanego pliku"
  ],
